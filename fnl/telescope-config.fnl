...
(nmap :<space>o (partial (fuzzy :treesitter) {:buffer 0})
      {:desc "fuzzy outline"})
(nmap :<space>ff (fuzzy :find_files) {:desc "fuzzy files"})
(nmap :<space>gf (fuzzy :git_files {:show_untracked false})
...
(nmap :<space>ht #(telescope.extensions.harpoon.marks)
      {:desc "fuzzy harpoon marks"})
