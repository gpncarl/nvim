...
(map :<leader><leader>w
     (partial hop.hint_words { :direction hint.HintDirection.AFTER_CURSOR :hint_position hint.HintPosition.BEGIN})
     { :desc "word begin after cursor" })

(map :<leader><leader>b
     (partial hop.hint_words { :direction hint.HintDirection.BEFORE_CURSOR :hint_position hint.HintPosition.BEGIN})
     { :desc "word begin before cursor" })

(map :<leader><leader>e
     (partial hop.hint_words { :direction hint.HintDirection.AFTER_CURSOR :hint_position hint.HintPosition.END})
     { :desc "word end after cursor" })

(map :<leader><leader>ge
     (partial hop.hint_words { :direction hint.HintDirection.BEFORE_CURSOR :hint_position hint.HintPosition.END})
...
(map :<leader><leader>J
     (partial hop.hint_lines_skip_whitespace { :direction hint.HintDirection.AFTER_CURSOR})
     { :desc "line head after cursor" })

(map :<leader><leader>K
     (partial hop.hint_lines_skip_whitespace { :direction hint.HintDirection.BEFORE_CURSOR})
